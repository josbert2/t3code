    ...
    execute: () =>
      sql`
        SELECT
          ...
          board_column_override AS "boardColumnOverride",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                boardColumnOverride: row.boardColumnOverride ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        boardColumnOverride: threadRow.value.boardColumnOverride ?? null,
