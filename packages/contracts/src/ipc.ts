...
export interface DesktopBridge {
  ...
  /**
   * Window buttons the renderer draws itself. Present only where the platform
   * gives Electron nothing to paint them with — Linux — so callers must treat
   * them as optional and hide their controls when they are missing.
   */
